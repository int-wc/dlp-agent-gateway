...
export function Reports() {
  ...
  return <>
    ...
    <Row gutter={[16, 16]}><Col xs={24} xl={10}><Card title="内容判定分布" className="chart-card">{report.data?.total ? <Chart option={actionChart} style={{ height: 330 }} /> : <Empty description="暂无报告数据" />}</Card></Col><Col xs={24} xl={14}><Card title="传输状态分布" className="chart-card"><Chart option={transferChart} style={{ height: 330 }} /></Card></Col></Row>
